        ...
        return (
            <div className="container-fluid">
                ...
                <div className='row h-100 justify-content-center align-items-center'>
                    <form className='m-4' onSubmit={this.onSubmitForm}>
                        <div className="form-row">
                            <div className="form-group col-md-6">
                                <label htmlFor="inputName">Name</label>
                                <input type="text" className="form-control" id="inputName" placeholder="John,David etc" required />
                            </div>
                            <div className="form-group col-md-6">
                        ...
                        <div className="form-group">
                            ...
                            <input type="tel" className="form-control" id="inputContact" placeholder="123456789" required />
                        </div>
                        <div className="form-row">
