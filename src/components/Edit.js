                ...
                <form className='m-4' onSubmit={this.onSubmitAd}>
                    <div className="form-row">
                        <div className="form-group col-md-6">
                            ...
                            <input type="text" className="form-control" value={this.state.ad.adTitle} id="adTitle" placeholder="Ad Title" required/>
                        </div>
                        <div className="form-group col-md-6">
                            <label htmlFor="condition">Item Condition</label>
                            <select className="custom-select" value={this.state.ad.itemCondition} id='condition' required>
                    ...
                    <div className="form-row">
                        <div className="form-group col-md-6">
                            ...
                            <input type="number" className="form-control" id="price" value={this.state.ad.price} required />
                        </div>
                        <div className="form-group col-md-6">
                            <label htmlFor="inputCity">City</label>
                            <select className="custom-select" id='inputCity' value={this.state.ad.city} required>
