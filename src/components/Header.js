...
class Header extends Component {
  ...
  render() {
    return <div className="container-fluid border" id='headerMain'>
      <div>
        <ToastContainer />
      </div>
      <nav className="navbar fixed-top navbar-expand-lg navbar-light  bg-light ">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav mr-auto">
            ...
            {this.props.auth ? <li className={this.props.auth ? "nav-item" : "d-none"}>
            ...
            <li className={this.props.visible ? "nav-item" : "d-none"}>
              <Link className="nav-link" to={`${this.props.postAddress}/postad`}>
                Post Ad
                </Link>
            </li>
            {this.props.auth ? <li className={this.props.auth ? "nav-item" : "d-none"}>
          ...
          <form className="form-inline my-2 my-lg-0" onSubmit={this.searchHandler}>
            <input className="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" id="searchInput" required />
            ...
            <button className="btn btn-outline-primary my-sm-0 mr-2" type="submit" id="searchBtn">
              Search
              </button>
          </form>
        </div>
